...
void Controller::updateWalkerPositions() {
    ...
    m_visualData.pointsData.positions = m_simulator.particles;
    for(unsigned int i=0; i<m_visualData.pointsData.positions.size(); i++) {
        m_visualData.pointsData.positions[i][0] *= m_simulator.scale;
        m_visualData.pointsData.positions[i][1] *= m_simulator.scale;
    }
